...
REQUIRED_VALUES = frozenset(
    {
        ...
        "NOTIFICATION_SERVICE_MAIL_FROM",
...
FIXED_PRODUCTION_VALUES = {
    ...
    "NOTIFICATION_SERVICE_SMTP_HOST": "smtp.resend.com",
    "NOTIFICATION_SERVICE_SMTP_PORT": "587",
    "NOTIFICATION_SERVICE_SMTP_AUTH": "true",
    "NOTIFICATION_SERVICE_SMTP_STARTTLS": "true",
    "NOTIFICATION_SERVICE_SMTP_USERNAME": "resend",
    "NOTIFICATION_SERVICE_MAIL_FROM": "no-reply@batchdownloader.dev",
...
def validate_environment(values: Mapping[str, str], expected_tag: str | None = None) -> None:
