...
def upgrade() -> None:
    """Aplica la revisión Alembic `20260627` para actualizar el esquema del Scraper de forma
    reproducible.
    """
...
def downgrade() -> None:
    """Revierte la revisión Alembic `20260627` en el orden inverso, conservando los
